...
ticker = ['AAPL','TSLA','ABNB']
timeframe= ['15','20','25','30','35','40','45','50','55','75','90','105','135','150','165','195','210','225','255','270','285','315','330','345','375','390','405','435','450','465','495','510','525','550','570','585']
...
if __name__ == "__main__":
    ...
    for element2 in ticker:
        for element in timeframe:
            for element3 in liste_date:
                nom_variable = f"variable_{compteur}"
                variables[nom_variable] = ["python3", "ADRT2-test.py", element, 'minute', f'2023-{element3}', element2]
                compteur = compteur +1
            compteur = 1
            processes = []
            for i in range(1, len(variables)+1):
                th = Process(target=execute_command, args=(variables[f"variable_{i}"],))
                processes.append(th)
                th.start()
